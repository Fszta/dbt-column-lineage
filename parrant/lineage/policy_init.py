...
DEFAULT_OUTPUT_PATH = "./dbt-col-lineage.policy.yml"
...
def _header_lines() -> List[str]:
    ...
    return [
        "# ============================================================================",
        "# dbt-col-lineage policy — generated by `dbt-col-lineage policy init`",
        "#",
        ...
        "#   Run `dbt-col-lineage policy test --last 20` to replay this policy over your",
...
def _footer_lines() -> List[str]:
    return [
        "",
        "# --- Next steps -------------------------------------------------------------",
        "# 1. Run `dbt-col-lineage policy test --last 20` to see what these rules WOULD have",
