const ExploreModule = (function() {
    ...
    const iconSource = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" class="tree-icon source-icon"><path d=" 6.5 L4 17.5 A8 2.9 0 0 0 20 17.5 L20 6.5 A8 2.9 0 0 1 4 6.5 Z" fill="currentColor" fill-opacity="0.16"/><path d=" 6.5 V17.5 A8 2.9 0 0 0 20 17.5 V6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d=" 12 A8 2.9 0 0 0 20 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><ellipse cx="12" cy="6.5" rx="8" ry="2.9" fill="currentColor" fill-opacity="0.42" stroke="currentColor" stroke-width="1.5"/></svg>`;
    const iconSeed = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" class="tree-icon seed-icon"><path d=" 6C3 4.34315 4.34315 3 6 3H14L18 7V18C18 19.6569 16.6569 21 15 21H6C4.34315 21 3 19.6569 3 18V6Z" fill="currentColor" fill-opacity="0.2" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M14 3V7H18" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/><path d="M7 12H14M7 16H11" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>`;
