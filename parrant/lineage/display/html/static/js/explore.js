const ExploreModule = (function() {
    ...
    const iconSource = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" class="tree-icon source-icon"><path d="M4 6.5 L4 17.5 A8 2.9 0 0 0 20 17.5 L20 6.5 A8 2.9 0 0 1 4 6.5 Z" fill="currentColor" fill-opacity="0.16"/><path d="M4 6.5 V17.5 A8 2.9 0 0 0 20 17.5 V6.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><path d="M4 12 A8 2.9 0 0 0 20 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/><ellipse cx="12" cy="6.5" rx="8" ry="2.9" fill="currentColor" fill-opacity="0.42" stroke="currentColor" stroke-width="1.5"/></svg>`;
