...
from dbt_column_lineage.metabase.artifact import dump_metabase_lineage
...
def _extractor_version() -> str:
    try:
        return version("dbt-col-lineage")
...
def metabase_extract(
    ...
    click.echo(
        ...
        f"{cov.dashboards_total} dashboards. Coverage {ratio:.0%}.",
        err=True,
    )
